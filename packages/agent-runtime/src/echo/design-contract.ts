...
function isVisualPath(filePath: string): boolean {
...
function allowedColors(contract: DesignContract): Set<string> {
  return new Set(
...
function unsupportedTypography(
  content: string,
  contract: DesignContract,
): string[] {
...
function computedCssProperties(content: string): string[] {
...
function dynamicVisualProperties(content: string): string[] {
  const properties: string[] = []
...
function unknownColors(content: string, allowed: Set<string>): string[] {
  const found: string[] = []
...
function unsupportedTypographyValues(
  content: string,
  contract: DesignContract,
): string[] {
...
function missingComponentTokens(
  content: string,
  contract: DesignContract,
): string[] {
...
function missingAccessibilityTokens(
  contract: DesignContract,
  content: string,
): string[] {
