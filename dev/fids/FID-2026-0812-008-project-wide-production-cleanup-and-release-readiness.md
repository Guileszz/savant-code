...
- **Fix Description:** Planning scope converged after Nova’s independent audit; implementation is not yet complete. The FID remains active for the bounded cleanup and re-audit batches.
