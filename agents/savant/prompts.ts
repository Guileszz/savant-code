...
${buildArray(
  ...
  '- IMPORTANT: You have write_file and str_replace — write code directly for most tasks. Use the full ECHO Perfection Loop (spawn Forge) only for genuinely complex changes (> 20 lines AND new imports/APIs, OR novel architecture, OR verification fails twice, OR user requests Forge). Otherwise write the code yourself, then verify with typecheck/lint in parallel using bashers.',
