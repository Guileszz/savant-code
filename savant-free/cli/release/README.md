...
An AI coding agent that runs in your terminal — describe what you want, and SavantFree edits your code.
...
- [Documentation](https://savant-code.com/docs)
- [GitHub](https://github.com/savant0x/savant-code)
- [Website](https://savant-code.com)

> Built on the [SavantCode](https://savant-code.com) platform.
