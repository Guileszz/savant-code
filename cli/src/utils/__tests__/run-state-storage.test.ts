...
import {
  ...
  getChatMessagesPath as _getChatMessagesPath,
  saveChatState,
  loadMostRecentChatState,
  clearChatState as _clearChatState,
...
const _originalGetProjectDataDir = () => mockProjectDataDir
const _originalGetCurrentChatDir = () => mockCurrentChatDir
